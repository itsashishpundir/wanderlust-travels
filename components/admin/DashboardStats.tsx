...
export const DashboardStats = () => (
    <div className="space-y-6 animate-fade-in">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
                { title: 'Total Revenue', value: '$124,500', trend: '+12.5%', color: 'bg-green-500', icon: DollarSign },
                { title: 'Total Bookings', value: '1,845', trend: '+5.2%', color: 'bg-blue-500', icon: FileText },
                { title: 'Active Users', value: '2,342', trend: '+18.0%', color: 'bg-purple-500', icon: Users },
                { title: 'Pending Requests', value: '12', trend: '-2.4%', color: 'bg-orange-500', icon: Bell }
            ].map((stat, idx) => (
                    ...
                    {MOCK_BOOKINGS.slice(0, 4).map((booking) => (
                        <div key={booking.id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/30 rounded-lg">
                            <div className="flex items-center">
                                ...
                                <div>
                                    <p className="text-sm font-bold text-gray-900 dark:text-white">{booking.customerName}</p>
