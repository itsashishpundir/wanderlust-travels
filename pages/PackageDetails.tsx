      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 h-[400px] mb-8 rounded-2xl overflow-hidden">
              ...
              <div className="hidden md:flex flex-col gap-4 h-full">
                  <img src={pkg.images[0]} alt="Sub 1" className="w-full h-1/2 object-cover hover:scale-105 transition duration-500 cursor-pointer" />
                  <div className="relative h-1/2">
                    <img src={pkg.images[1]} alt="Sub 2" className="w-full h-full object-cover hover:scale-105 transition duration-500 cursor-pointer" />
